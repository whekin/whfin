 ...
 *
 * Дата не фиксированная, а окно ([expectedDayFrom]..[expectedDayTo]): реальная выплата гуляет, а
 * первая выплата на новом месте вообще не попадает ни в какой шаблон.
 *

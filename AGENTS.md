...
- [~] Core UI: есть лента (группировка по дням, иконки категорий, переводы серым), счета (баланс
  ...
  Room (`feedLoaded`) и молчит, пока любой блок выше уже называет деньги — экран не может одновременно
  перечислять обязательства и предлагать начать сначала. Детали: `docs/home-screen.md`

...
- [~] Core UI: есть лента (группировка по дням, иконки категорий, переводы серым), счета (баланс
  ...
  Launcher icon переработан (2026-07-16): вместо W-монограммы — стилизованный лари по утверждённой
  владельцем генерации: стем сквозь чашу, чаша перетекает в базовую ledger-линию, глиняная точка —
  свежая запись. Кремовый штрих на бутылочном фоне; adaptive icon с monochrome-слоем, глиф ужат
  group-трансформом под жёсткую маску splash (ничего не касается кромки круга).

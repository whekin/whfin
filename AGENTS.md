...
- [x] Feed UX: поиск по операции/счёту/IBAN и единый полноразмерный фильтр по типу, нескольким
  категориям и сортировке; быстрые чипы и Settings убраны с рабочей поверхности Transactions,
  а глобальное добавление операции встроено отдельной 52dp-кнопкой в центр dock;

...
- [~] Core UI: есть лента (группировка по дням, иконки категорий, переводы серым), счета (баланс
  ...
  Launcher icon переработан (2026-07-16): вместо W-монограммы — глиф лари ₾ кремовым штрихом на
  бутылочном фоне с глиняной «чертой итога» снизу; adaptive icon с monochrome-слоем, форма
  специально проверена против прочтения как power-кнопки (штрихи пересекают полный круг чаши).
